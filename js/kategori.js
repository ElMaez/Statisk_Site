...
fetch("https://kea-alt-del.dk/t7/api/categories")
  ...
  .then((categories) => {
    categories.forEach((category) => {
      categoryList.innerHTML += `<li class="button" ><a href="kategori.html?category=${category.category}">${category.category}</a></li>`;
    });
  });
...
//           .setAttribute(
//             "src",
//             `https://kea-alt-del.dk/t7/images/jpg/640/${product.id}.jpg`
//           );
//         if (product.soldout) {
